...
class ErrorDialogGUI ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.m_staticText1 = wx.StaticText( self, wx.ID_ANY, u"Fatal error when replicating layout. You can raise an issue on GiHub page.                    + \"Please attach the save_restore_layout.log which you should find in the project folder.", wx.DefaultPosition, wx.DefaultSize, 0 )
