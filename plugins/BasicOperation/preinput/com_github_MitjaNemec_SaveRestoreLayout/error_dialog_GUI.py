...
class ErrorDialogGUI ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Save/Restore Layout", pos = wx.DefaultPosition, size = wx.Size( 458,212 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self.m_hyperlink1 = wx.adv.HyperlinkCtrl( self, wx.ID_ANY, u"https://github.com/MitjaNemec/SaveRestoreLayout", u"https://github.com/MitjaNemec/SaveRestoreLayout", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
